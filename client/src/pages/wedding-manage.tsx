                    ...
                    <div>
                      ...
                      <div className="mb-4 p-4 border-2 border-dashed border-gray-300 rounded-lg">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-gray-500 mb-3">This photo will appear at the top of your wedding site</p>
                          <input
                            type="file"
                            accept="image/*"
                            onChange={(e) => {
                    ...
                    <div>
                      ...
                      <div className="mb-4 p-4 border-2 border-dashed border-gray-300 rounded-lg">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-gray-500 mb-3">These photos will appear in the photo gallery section</p>
                          <input
                            type="file"
                            accept="image/*"
                            multiple
                          ...
                          <label
                            ...
                            className="inline-flex items-center px-4 py-2 bg-[#89916B] text-white rounded-lg hover:bg-[#7A8260] cursor-pointer"
                          >
                            <Camera className="h-4 w-4 mr-2" />
